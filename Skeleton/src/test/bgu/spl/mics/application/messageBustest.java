...
public class messageBustest {
    ...
    //The pre conditions, post conditions and invariants are in the MessageBusImpl class above register method

    //this 2 invariants are kept during the tests
    ...
    //method under test - unRegister.

    //The pre conditions, post conditions and invariants are in the MessageBusImpl class above unRegister method
